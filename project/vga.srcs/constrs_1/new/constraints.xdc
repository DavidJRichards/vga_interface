...
set_property -dict {PACKAGE_PIN L16 IOSTANDARD LVCMOS33} [get_ports {VGA_R[5]}]
set_property -dict {PACKAGE_PIN J20 IOSTANDARD LVCMOS33} [get_ports {VGA_R[4]}]
set_property -dict {PACKAGE_PIN K19 IOSTANDARD LVCMOS33} [get_ports {VGA_R[3]}]
...
set_property -dict {PACKAGE_PIN H20 IOSTANDARD LVCMOS33} [get_ports {VGA_R[0]}]

set_property -dict {PACKAGE_PIN U20 IOSTANDARD LVCMOS33} [get_ports {VGA_B[5]}]
set_property -dict {PACKAGE_PIN T20 IOSTANDARD LVCMOS33} [get_ports {VGA_B[4]}]
set_property -dict {PACKAGE_PIN P19 IOSTANDARD LVCMOS33} [get_ports {VGA_B[3]}]
set_property -dict {PACKAGE_PIN R19 IOSTANDARD LVCMOS33} [get_ports {VGA_B[2]}]
set_property -dict {PACKAGE_PIN R18 IOSTANDARD LVCMOS33} [get_ports {VGA_B[1]}]
set_property -dict {PACKAGE_PIN P20 IOSTANDARD LVCMOS33} [get_ports {VGA_B[0]}]

set_property -dict {PACKAGE_PIN U19 IOSTANDARD LVCMOS33} [get_ports VGA_HSYNC]
set_property -dict {PACKAGE_PIN V20 IOSTANDARD LVCMOS33} [get_ports VGA_VSYNC]

# PS/2 Keyboard
set_property -dict { PACKAGE_PIN U12   IOSTANDARD LVCMOS33 } [get_ports { PS2_CLOCK }];
set_property -dict { PACKAGE_PIN V13   IOSTANDARD LVCMOS33 } [get_ports { PS2_DATA }];
